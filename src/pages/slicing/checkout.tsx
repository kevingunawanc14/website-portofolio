          ...
          <div className='mt-[20px]'>
            <div>
              <div className='bg-slicing-grey1 rounded border border-slicing-grey1 '>
                <div className='grid grid-cols-3 px-[40px] py-[20px]'>
                  <div className='content-center'>
                    <div>
                      <div>
                        <p className='text-[12px] md:text-[16px] lg:text-[20px] poppins-bold text-center'>ID Pesanan</p>
                      </div>
                      <div>
                        <p className='text-[10px] md:text-[14px] lg:text-[18px] poppins-bold text-slicing-grey text-center'>#8932424</p>
                      </div>
                    </div>
                  </div>
                  <div className='content-center'>
                    <div>
                      <div>
                        <p className='text-[12px] md:text-[16px] lg:text-[20px] poppins-bold text-center'>Metode Pembayaran </p>
                      </div>
                  ...
                  <div className='content-center'>
                    <div>
                      <div>
                        <p className='text-[12px] md:text-[16px] lg:text-[20px] poppins-bold text-center'>Jadwal Sewa</p>
                      </div>
                      <div>
                        <p className='text-[10px] md:text-[14px] lg:text-[18px] poppins-bold text-slicing-grey text-center'>17 Agustus 2024 - 18 Agustus 2024</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-5 mt-[20px] gap-3' >
              <div>
                <div className=''>
                  <div>
                    <div className='flex justify-center'>
            ...
            <div className='bg-slicing-grey1 rounded border border-slicing-greyBorder mt-[20px]'>
              <div className='p-[20px]'>
                ...
                {/* List */}
                <div>
                  <div className='hidden lg:grid lg:grid-cols-6 gap-4 mt-[20px]'>
                    <div>
                      <div className='bg-slicing-deep rounded flex justify-center'>
                        <img src="/images/slicing/redBag.png" className='lg:w-[100px] lg:h-[100px] sm:w-[80px] sm:h-[80px] w-[55px] h-[55px] ' alt="" />
                      </div>
                    ...
                    <div>
                      <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold text-slicing-grey'>x1</p>
                  ...
                  <div className='grid grid-cols-4 lg:hidden  mt-[20px] gap-3'>
                    ...
                    <div className='col-span-3'>
                      ...
                      <div className='flex justify-between'>
                        <div className='flex justify-between'>
                          <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold text-slicing-grey'>Rp 25.000</p>
                          <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold text-slicing-grey ms-[25px]'>x1</p>
                        </div>
                        <div>
                          <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold '>Rp 25.000</p>
                        </div>
                ...
                <div>
                  <div className='hidden lg:grid lg:grid-cols-6 gap-4 mt-[20px]'>
                    <div>
                      <div className='bg-slicing-deep rounded flex justify-center'>
                        <img src="/images/slicing/camp.png" className='lg:w-[100px] lg:h-[100px] sm:w-[80px] sm:h-[80px] w-[55px] h-[55px] ' alt="" />
                      </div>

                    </div>
                    <div>
                      <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold'>Tenda 4-5 Orang</p>
                    </div>
                    <div>
                      <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold text-slicing-grey'>1 hari</p>
                    </div>
                    ...
                    <div>
                      <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold text-slicing-grey'>Rp 35.000</p>

                    </div>
                    <div>
                      <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold '>Rp 35.000</p>
                ...
                <div>
                  <div className='hidden lg:grid lg:grid-cols-6 gap-4 mt-[20px]'>
                    <div>
                      <div className='bg-slicing-deep rounded flex justify-center'>
                        <img src="/images/slicing/Sepatu.png" className='lg:w-[100px] lg:h-[100px] sm:w-[80px] sm:h-[80px] w-[55px] h-[55px] ' alt="" />
                      </div>

                    </div>
                    <div>
                      <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold'>Sepatu</p>
                    </div>
                    <div>
                      <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold text-slicing-grey'>1 hari</p>
                    </div>
                    ...
                    <div>
                      <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold text-slicing-grey'>Rp 10.000</p>

                    </div>
                    <div>
                      <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold '>Rp 10.000</p>
                ...
                <div>
                  <div className='hidden lg:grid lg:grid-cols-6 gap-4 mt-[20px]'>
                    <div>
                      <div className='bg-slicing-deep rounded flex justify-center'>
                        <img src="/images/slicing/sleepingBag.png" className='lg:w-[100px] lg:h-[100px] sm:w-[80px] sm:h-[80px] w-[55px] h-[55px] ' alt="" />
                      </div>

                    </div>
                    <div>
                      <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold'>Sleeping Bag</p>
                    </div>
                    <div>
                      <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold text-slicing-grey'>1 hari</p>
                    </div>
                ...
                <div>
                  <div className='hidden lg:grid lg:grid-cols-6 gap-4 mt-[20px]'>
                    <div>
                      <div className='bg-slicing-deep rounded flex justify-center'>
                        <img src="/images/slicing/kompor.png" className='lg:w-[100px] lg:h-[100px] sm:w-[80px] sm:h-[80px] w-[55px] h-[55px] ' alt="" />
                      </div>

                    </div>
                    <div>
                      <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold'>Kompor</p>
                    </div>
                    <div>
                      <p className='text-[12px] md:text-[16px] lg:text-[18px] poppins-bold text-slicing-grey'>1 hari</p>
                    </div>
