        ...
        <div className='container'>
          ...
          <div className='pt-[50px]'>
            ...
            <div className='mt-[5px]'>
                ...
                <div className='hidden lg:flex justify-between'>
                  ...
                  <div>
                    <div className="relative">
                      ...
                      <input type="text" id="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-slicing-foreground focus:border-slicing-foreground block w-[304px] p-2.5 " placeholder="Cari Alat"
                        required />
                    </div>
                  </div>
                </div>
              ...
              <div>
                <div>
                  <div className='hidden sm:flex justify-between lg:hidden'>
                    <div id="date-range-picker" date-rangepicker className="flex items-center">
                      <div className="relative">
                        <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                          <svg className="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className='ms-[5px] '>
                      <div className=''>
                        <button type="button" className="px-3 py-2 inline-flex items-center text-white bg-slicing-foreground rounded w-[170px]  justify-center">
                  ...
                  <div className='hidden sm:flex justify-end lg:hidden mt-[15px]'>
                    <div className="relative">
                      <div className="absolute inset-y-0 end-0 flex items-center pe-3.5 pointer-events-none">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M15.5005 13.9995H14.7105L14.4305 13.7295C15.0554 13.0035 15.5122 12.1483 15.768 11.2251C16.0239 10.3019 16.0725 9.33364 15.9105 8.38949C15.4405 5.60949 13.1205 3.38949 10.3205 3.04949C9.33608 2.92495 8.33625 3.02726 7.39749 3.34858C6.45872 3.66989 5.60591 4.20171 4.90429 4.90332C4.20268 5.60493 3.67087 6.45775 3.34955 7.39651C3.02823 8.33527 2.92593 9.3351 3.05046 10.3195C3.39046 13.1195 5.61046 15.4395 8.39046 15.9095C9.33462 16.0715 10.3029 16.0229 11.2261 15.767C12.1492 15.5112 13.0044 15.0544 13.7305 14.4295L14.0005 14.7095V15.4995L18.2505 19.7495C18.6605 20.1595 19.3305 20.1595 19.7405 19.7495C20.1505 19.3395 20.1505 18.6695 19.7405 18.2595L15.5005 13.9995ZM9.50046 13.9995C7.01046 13.9995 5.00046 11.9895 5.00046 9.49949C5.00046 7.00949 7.01046 4.99949 9.50046 4.99949C11.9905 4.99949 14.0005 7.00949 14.0005 9.49949C14.0005 11.9895 11.9905 13.9995 9.50046 13.9995Z" fill="black" />
          ...
          <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mt-[20px]'>
            ...
            <div>
              <div className="shadow-md rounded    ">
                <img className=" bg-slicing-deep rounded-t" src="/images/slicing/matras.png" alt="" />
                <div className="p-5">
                  <p className='text-[12px] lg:text-[14px]  xl:text-[20px] poppins-bold truncate'>Matras Spon</p>
                  <p className="text-[12px] lg:text-[12px]  xl:text-[18px] text-slicing-grey poppins-regular mt-2">Rp. 5.000 <span className='text-end'> / hari</span></p>
                  <div className='flex justify-center mt-2'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17 18C15.89 18 15 18.89 15 20C15 20.5304 15.2107 21.0391 15.5858 21.4142C15.9609 21.7893 16.4696 22 17 22C17.5304 22 18.0391 21.7893 18.4142 21.4142C18.7893 21.0391 19 20.5304 19 20C19 19.4696 18.7893 18.9609 18.4142 18.5858C18.0391 18.2107 17.5304 18 17 18ZM1 2V4H3L6.6 11.59L5.24 14.04C5.09 14.32 5 14.65 5 15C5 15.5304 5.21071 16.0391 5.58579 16.4142C5.96086 16.7893 6.46957 17 7 17H19V15H7.42C7.3537 15 7.29011 14.9737 7.24322 14.9268C7.19634 14.8799 7.17 14.8163 7.17 14.75C7.17 14.7 7.18 14.66 7.2 14.63L8.1 13H15.55C16.3 13 16.96 12.58 17.3 11.97L20.88 5.5C20.95 5.34 21 5.17 21 5C21 4.73478 20.8946 4.48043 20.7071 4.29289C20.5196 4.10536 20.2652 4 20 4H5.21L4.27 2M7 18C5.89 18 5 18.89 5 20C5 20.5304 5.21071 21.0391 5.58579 21.4142C5.96086 21.7893 6.46957 22 7 22C7.53043 22 8.03914 21.7893 8.41421 21.4142C8.78929 21.0391 9 20.5304 9 20C9 19.4696 8.78929 18.9609 8.41421 18.5858C8.03914 18.2107 7.53043 18 7 18Z" fill="#156E3E" />
                    </svg>
            ...
            <div>
              <div className="shadow-md rounded    ">
                <img className=" bg-slicing-deep rounded-t" src="/images/slicing/Sepatu.png" alt="" />
                <div className="p-5">
                  <p className='text-[12px] lg:text-[14px]  xl:text-[20px] poppins-bold truncate'>Sepatu</p>
                  <p className="text-[12px] lg:text-[12px]  xl:text-[18px] text-slicing-grey poppins-regular mt-2">Rp. 25.000 <span className='text-end'> / hari</span></p>
                  <div className='flex justify-center mt-2'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17 18C15.89 18 15 18.89 15 20C15 20.5304 15.2107 21.0391 15.5858 21.4142C15.9609 21.7893 16.4696 22 17 22C17.5304 22 18.0391 21.7893 18.4142 21.4142C18.7893 21.0391 19 20.5304 19 20C19 19.4696 18.7893 18.9609 18.4142 18.5858C18.0391 18.2107 17.5304 18 17 18ZM1 2V4H3L6.6 11.59L5.24 14.04C5.09 14.32 5 14.65 5 15C5 15.5304 5.21071 16.0391 5.58579 16.4142C5.96086 16.7893 6.46957 17 7 17H19V15H7.42C7.3537 15 7.29011 14.9737 7.24322 14.9268C7.19634 14.8799 7.17 14.8163 7.17 14.75C7.17 14.7 7.18 14.66 7.2 14.63L8.1 13H15.55C16.3 13 16.96 12.58 17.3 11.97L20.88 5.5C20.95 5.34 21 5.17 21 5C21 4.73478 20.8946 4.48043 20.7071 4.29289C20.5196 4.10536 20.2652 4 20 4H5.21L4.27 2M7 18C5.89 18 5 18.89 5 20C5 20.5304 5.21071 21.0391 5.58579 21.4142C5.96086 21.7893 6.46957 22 7 22C7.53043 22 8.03914 21.7893 8.41421 21.4142C8.78929 21.0391 9 20.5304 9 20C9 19.4696 8.78929 18.9609 8.41421 18.5858C8.03914 18.2107 7.53043 18 7 18Z" fill="#156E3E" />
            ...
            <div>
              <div className="shadow-md rounded    ">
                <img className=" bg-slicing-deep rounded-t" src="/images/slicing/kompor.png" alt="" />
                <div className="p-5">
                  <p className='text-[12px] lg:text-[14px]  xl:text-[20px] poppins-bold truncate'>Kompor</p>
                  <p className="text-[12px] lg:text-[12px]  xl:text-[18px] text-slicing-grey poppins-regular mt-2">Rp. 10.000 <span className='text-end'> / hari</span></p>
                  <div className='flex justify-center mt-2'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17 18C15.89 18 15 18.89 15 20C15 20.5304 15.2107 21.0391 15.5858 21.4142C15.9609 21.7893 16.4696 22 17 22C17.5304 22 18.0391 21.7893 18.4142 21.4142C18.7893 21.0391 19 20.5304 19 20C19 19.4696 18.7893 18.9609 18.4142 18.5858C18.0391 18.2107 17.5304 18 17 18ZM1 2V4H3L6.6 11.59L5.24 14.04C5.09 14.32 5 14.65 5 15C5 15.5304 5.21071 16.0391 5.58579 16.4142C5.96086 16.7893 6.46957 17 7 17H19V15H7.42C7.3537 15 7.29011 14.9737 7.24322 14.9268C7.19634 14.8799 7.17 14.8163 7.17 14.75C7.17 14.7 7.18 14.66 7.2 14.63L8.1 13H15.55C16.3 13 16.96 12.58 17.3 11.97L20.88 5.5C20.95 5.34 21 5.17 21 5C21 4.73478 20.8946 4.48043 20.7071 4.29289C20.5196 4.10536 20.2652 4 20 4H5.21L4.27 2M7 18C5.89 18 5 18.89 5 20C5 20.5304 5.21071 21.0391 5.58579 21.4142C5.96086 21.7893 6.46957 22 7 22C7.53043 22 8.03914 21.7893 8.41421 21.4142C8.78929 21.0391 9 20.5304 9 20C9 19.4696 8.78929 18.9609 8.41421 18.5858C8.03914 18.2107 7.53043 18 7 18Z" fill="#156E3E" />
            ...
            <div>
              <div className="shadow-md rounded    ">
                <img className=" bg-slicing-deep rounded-t" src="/images/slicing/lampu tenda.png" alt="" />
                <div className="p-5">
                  <p className='text-[12px] lg:text-[14px]  xl:text-[20px] poppins-bold truncate'>Lampu Tenda</p>
                  <p className="text-[12px] lg:text-[12px]  xl:text-[18px] text-slicing-grey poppins-regular mt-2">Rp. 5.000 <span className='text-end'> / hari</span></p>
                  <div className='flex justify-center mt-2'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17 18C15.89 18 15 18.89 15 20C15 20.5304 15.2107 21.0391 15.5858 21.4142C15.9609 21.7893 16.4696 22 17 22C17.5304 22 18.0391 21.7893 18.4142 21.4142C18.7893 21.0391 19 20.5304 19 20C19 19.4696 18.7893 18.9609 18.4142 18.5858C18.0391 18.2107 17.5304 18 17 18ZM1 2V4H3L6.6 11.59L5.24 14.04C5.09 14.32 5 14.65 5 15C5 15.5304 5.21071 16.0391 5.58579 16.4142C5.96086 16.7893 6.46957 17 7 17H19V15H7.42C7.3537 15 7.29011 14.9737 7.24322 14.9268C7.19634 14.8799 7.17 14.8163 7.17 14.75C7.17 14.7 7.18 14.66 7.2 14.63L8.1 13H15.55C16.3 13 16.96 12.58 17.3 11.97L20.88 5.5C20.95 5.34 21 5.17 21 5C21 4.73478 20.8946 4.48043 20.7071 4.29289C20.5196 4.10536 20.2652 4 20 4H5.21L4.27 2M7 18C5.89 18 5 18.89 5 20C5 20.5304 5.21071 21.0391 5.58579 21.4142C5.96086 21.7893 6.46957 22 7 22C7.53043 22 8.03914 21.7893 8.41421 21.4142C8.78929 21.0391 9 20.5304 9 20C9 19.4696 8.78929 18.9609 8.41421 18.5858C8.03914 18.2107 7.53043 18 7 18Z" fill="#156E3E" />
            ...
            <div>
              <div className="shadow-md rounded    ">
                <img className=" bg-slicing-deep rounded-t" src="/images/slicing/head lamp.png" alt="" />
                <div className="p-5">
                  <p className='text-[12px] lg:text-[14px]  xl:text-[20px] poppins-bold truncate'>Headlamp</p>
                  <p className="text-[12px] lg:text-[12px]  xl:text-[18px] text-slicing-grey poppins-regular mt-2">Rp. 5.000 <span className='text-end'> / hari</span></p>
                  <div className='flex justify-center mt-2'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17 18C15.89 18 15 18.89 15 20C15 20.5304 15.2107 21.0391 15.5858 21.4142C15.9609 21.7893 16.4696 22 17 22C17.5304 22 18.0391 21.7893 18.4142 21.4142C18.7893 21.0391 19 20.5304 19 20C19 19.4696 18.7893 18.9609 18.4142 18.5858C18.0391 18.2107 17.5304 18 17 18ZM1 2V4H3L6.6 11.59L5.24 14.04C5.09 14.32 5 14.65 5 15C5 15.5304 5.21071 16.0391 5.58579 16.4142C5.96086 16.7893 6.46957 17 7 17H19V15H7.42C7.3537 15 7.29011 14.9737 7.24322 14.9268C7.19634 14.8799 7.17 14.8163 7.17 14.75C7.17 14.7 7.18 14.66 7.2 14.63L8.1 13H15.55C16.3 13 16.96 12.58 17.3 11.97L20.88 5.5C20.95 5.34 21 5.17 21 5C21 4.73478 20.8946 4.48043 20.7071 4.29289C20.5196 4.10536 20.2652 4 20 4H5.21L4.27 2M7 18C5.89 18 5 18.89 5 20C5 20.5304 5.21071 21.0391 5.58579 21.4142C5.96086 21.7893 6.46957 22 7 22C7.53043 22 8.03914 21.7893 8.41421 21.4142C8.78929 21.0391 9 20.5304 9 20C9 19.4696 8.78929 18.9609 8.41421 18.5858C8.03914 18.2107 7.53043 18 7 18Z" fill="#156E3E" />
            ...
            <div>
              <div className="shadow-md rounded    ">
                <img className=" bg-slicing-deep rounded-t" src="/images/slicing/tracking pole.png" alt="" />
                <div className="p-5">
                  <p className='text-[12px] lg:text-[14px]  xl:text-[20px] poppins-bold truncate'>Tracking Pole</p>
                  <p className="text-[12px] lg:text-[12px]  xl:text-[18px] text-slicing-grey poppins-regular mt-2">Rp. 10.000 <span className='text-end'> / hari</span></p>
                  <div className='flex justify-center mt-2'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17 18C15.89 18 15 18.89 15 20C15 20.5304 15.2107 21.0391 15.5858 21.4142C15.9609 21.7893 16.4696 22 17 22C17.5304 22 18.0391 21.7893 18.4142 21.4142C18.7893 21.0391 19 20.5304 19 20C19 19.4696 18.7893 18.9609 18.4142 18.5858C18.0391 18.2107 17.5304 18 17 18ZM1 2V4H3L6.6 11.59L5.24 14.04C5.09 14.32 5 14.65 5 15C5 15.5304 5.21071 16.0391 5.58579 16.4142C5.96086 16.7893 6.46957 17 7 17H19V15H7.42C7.3537 15 7.29011 14.9737 7.24322 14.9268C7.19634 14.8799 7.17 14.8163 7.17 14.75C7.17 14.7 7.18 14.66 7.2 14.63L8.1 13H15.55C16.3 13 16.96 12.58 17.3 11.97L20.88 5.5C20.95 5.34 21 5.17 21 5C21 4.73478 20.8946 4.48043 20.7071 4.29289C20.5196 4.10536 20.2652 4 20 4H5.21L4.27 2M7 18C5.89 18 5 18.89 5 20C5 20.5304 5.21071 21.0391 5.58579 21.4142C5.96086 21.7893 6.46957 22 7 22C7.53043 22 8.03914 21.7893 8.41421 21.4142C8.78929 21.0391 9 20.5304 9 20C9 19.4696 8.78929 18.9609 8.41421 18.5858C8.03914 18.2107 7.53043 18 7 18Z" fill="#156E3E" />
            ...
            <div>
              <div className="shadow-md rounded    ">
                <img className=" bg-slicing-deep rounded-t" src="/images/slicing/nesting.png" alt="" />
                <div className="p-5">
            ...
            <div>
              <div className="shadow-md rounded    ">
                <img className=" bg-slicing-deep rounded-t" src="/images/slicing/fly sheet.png" alt="" />
                <div className="p-5">
                  <p className='text-[12px] lg:text-[14px]  xl:text-[20px] poppins-bold truncate'>Flysheet</p>
                  <p className="text-[12px] lg:text-[12px]  xl:text-[18px] text-slicing-grey poppins-regular mt-2">Rp. 10.000 <span className='text-end'> / hari</span></p>
                  <div className='flex justify-center mt-2'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17 18C15.89 18 15 18.89 15 20C15 20.5304 15.2107 21.0391 15.5858 21.4142C15.9609 21.7893 16.4696 22 17 22C17.5304 22 18.0391 21.7893 18.4142 21.4142C18.7893 21.0391 19 20.5304 19 20C19 19.4696 18.7893 18.9609 18.4142 18.5858C18.0391 18.2107 17.5304 18 17 18ZM1 2V4H3L6.6 11.59L5.24 14.04C5.09 14.32 5 14.65 5 15C5 15.5304 5.21071 16.0391 5.58579 16.4142C5.96086 16.7893 6.46957 17 7 17H19V15H7.42C7.3537 15 7.29011 14.9737 7.24322 14.9268C7.19634 14.8799 7.17 14.8163 7.17 14.75C7.17 14.7 7.18 14.66 7.2 14.63L8.1 13H15.55C16.3 13 16.96 12.58 17.3 11.97L20.88 5.5C20.95 5.34 21 5.17 21 5C21 4.73478 20.8946 4.48043 20.7071 4.29289C20.5196 4.10536 20.2652 4 20 4H5.21L4.27 2M7 18C5.89 18 5 18.89 5 20C5 20.5304 5.21071 21.0391 5.58579 21.4142C5.96086 21.7893 6.46957 22 7 22C7.53043 22 8.03914 21.7893 8.41421 21.4142C8.78929 21.0391 9 20.5304 9 20C9 19.4696 8.78929 18.9609 8.41421 18.5858C8.03914 18.2107 7.53043 18 7 18Z" fill="#156E3E" />
            ...
            <div>
              <div className="shadow-md rounded    ">
                <img className=" bg-slicing-deep rounded-t" src="/images/slicing/gas refill.png" alt="" />
                <div className="p-5">
                  <p className='text-[12px] lg:text-[14px]  xl:text-[20px] poppins-bold truncate'>Gas Refill</p>
                  <p className="text-[12px] lg:text-[12px]  xl:text-[18px] text-slicing-grey poppins-regular mt-2">Rp. 12.000 <span className='text-end'> / hari</span></p>
                  <div className='flex justify-center mt-2'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17 18C15.89 18 15 18.89 15 20C15 20.5304 15.2107 21.0391 15.5858 21.4142C15.9609 21.7893 16.4696 22 17 22C17.5304 22 18.0391 21.7893 18.4142 21.4142C18.7893 21.0391 19 20.5304 19 20C19 19.4696 18.7893 18.9609 18.4142 18.5858C18.0391 18.2107 17.5304 18 17 18ZM1 2V4H3L6.6 11.59L5.24 14.04C5.09 14.32 5 14.65 5 15C5 15.5304 5.21071 16.0391 5.58579 16.4142C5.96086 16.7893 6.46957 17 7 17H19V15H7.42C7.3537 15 7.29011 14.9737 7.24322 14.9268C7.19634 14.8799 7.17 14.8163 7.17 14.75C7.17 14.7 7.18 14.66 7.2 14.63L8.1 13H15.55C16.3 13 16.96 12.58 17.3 11.97L20.88 5.5C20.95 5.34 21 5.17 21 5C21 4.73478 20.8946 4.48043 20.7071 4.29289C20.5196 4.10536 20.2652 4 20 4H5.21L4.27 2M7 18C5.89 18 5 18.89 5 20C5 20.5304 5.21071 21.0391 5.58579 21.4142C5.96086 21.7893 6.46957 22 7 22C7.53043 22 8.03914 21.7893 8.41421 21.4142C8.78929 21.0391 9 20.5304 9 20C9 19.4696 8.78929 18.9609 8.41421 18.5858C8.03914 18.2107 7.53043 18 7 18Z" fill="#156E3E" />
                    </svg>
            ...
            <div>
              <div className="shadow-md rounded    ">
                <img className=" bg-slicing-deep rounded-t" src="/images/slicing/cooking set.png" alt="" />
                <div className="p-5">
                  <p className='text-[12px] lg:text-[14px]  xl:text-[20px] poppins-bold truncate'>Cooking Set</p>
                  <p className="text-[12px] lg:text-[12px]  xl:text-[18px] text-slicing-grey poppins-regular mt-2">Rp. 10.000 <span className='text-end'> / hari</span></p>
                  <div className='flex justify-center mt-2'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17 18C15.89 18 15 18.89 15 20C15 20.5304 15.2107 21.0391 15.5858 21.4142C15.9609 21.7893 16.4696 22 17 22C17.5304 22 18.0391 21.7893 18.4142 21.4142C18.7893 21.0391 19 20.5304 19 20C19 19.4696 18.7893 18.9609 18.4142 18.5858C18.0391 18.2107 17.5304 18 17 18ZM1 2V4H3L6.6 11.59L5.24 14.04C5.09 14.32 5 14.65 5 15C5 15.5304 5.21071 16.0391 5.58579 16.4142C5.96086 16.7893 6.46957 17 7 17H19V15H7.42C7.3537 15 7.29011 14.9737 7.24322 14.9268C7.19634 14.8799 7.17 14.8163 7.17 14.75C7.17 14.7 7.18 14.66 7.2 14.63L8.1 13H15.55C16.3 13 16.96 12.58 17.3 11.97L20.88 5.5C20.95 5.34 21 5.17 21 5C21 4.73478 20.8946 4.48043 20.7071 4.29289C20.5196 4.10536 20.2652 4 20 4H5.21L4.27 2M7 18C5.89 18 5 18.89 5 20C5 20.5304 5.21071 21.0391 5.58579 21.4142C5.96086 21.7893 6.46957 22 7 22C7.53043 22 8.03914 21.7893 8.41421 21.4142C8.78929 21.0391 9 20.5304 9 20C9 19.4696 8.78929 18.9609 8.41421 18.5858C8.03914 18.2107 7.53043 18 7 18Z" fill="#156E3E" />
