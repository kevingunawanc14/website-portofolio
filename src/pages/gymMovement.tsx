...
import { TextEffect } from '@/components/ui/motion-primitive/text-effect';
...
function gymMovement() {
    return (
        ...
        <div id='gym' className='h-screen mt-[500px]'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 container mx-auto justify-items-start'>
                    ...
                    <motion.div
                        ...
                        <div className="relative">
                            ...
                            <motion.div
                                ...
                                animate={{ rotate: 75 }} // rotates the line and the attached div
                                transition={{
                                    duration: 3, // controls how long each rotation takes
                                    repeat: Infinity, // repeats the animation infinitely
                                    repeatType: "mirror", // mirrors the animation (back and forth)
