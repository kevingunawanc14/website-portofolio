                        ...
                        <div className='grid grid-cols-12  '>
                            <div className='col-span-2 pt-[16px] '>
                                <div className='grid grid-row-6 gap-[1px]'>
                                    <div className='border-red-600 border-l-2 ms-[-1px] '>
                                        <p className='text-red-600 text-[14px] poppins-medium ms-[10px] p-[5px] '>Earnings and revenue history</p>
                                    </div>

                                    <div className='  ms-[-1px] p-[5px] '>
                                        <p className=' text-[14px]  text-slate-500  poppins-regular ms-[10px] '>Free Cash Flow vs Earnings <br />Analysis</p>
                                    </div>

                                    <div className='  ms-[-1px] p-[5px] '>
                                        <p className=' text-[14px]  text-slate-500   poppins-regular ms-[10px] '>Past Earnings Growth Analysis</p>
                                    </div>

                                    <div className='  ms-[-1px] p-[5px] '>
                                        <p className=' text-[14px] text-slate-500  poppins-regular ms-[10px] '>Return on Equity</p>
                                    </div>

                                    <div className='  ms-[-1px] p-[5px] '>
                                        <p className=' text-[14px]  text-slate-500   poppins-regular ms-[10px] '>Return on Assets</p>
                                    </div>

                                    <div className='  ms-[-1px] p-[5px] '>
                                        <p className=' text-[14px]  text-slate-500   poppins-regular ms-[10px] '>Return on Capital Employed </p>
                                    </div>
                                </div>
                            </div>
                            <div className='col-span-10'>
                                <div className='border-l border-b border-slate-300 p-[16px]'>
                                ...
                                <div className='border-l  border-slate-300 p-[16px]'>
                                    <p className='poppins-semibold text-[16px]'>Earnings and revenue history</p>
                                    <p className='poppins-regular text-[14px] text-gray-500'>This chart show historical financial metrics, including Free Cash Flow (FCF), earnings, revenue, and cash from operations. It can reflect company’s profitabillity and operation efficiency over time.</p>
                                    <div>
